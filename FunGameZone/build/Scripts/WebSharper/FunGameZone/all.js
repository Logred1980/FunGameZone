...
export function Main(){
  const container=_c_1.Create_1(Doc.Empty);
  const hostNameVar=_c_1.Create_1("");
  const roomNameVar=_c_1.Create_1("");
  const lastRoomCount=[0];
  const lastRoomState=[FSharpList.Empty];
  const renderRoom=(roomName, roomToken, hostName, created, isOpen) => {
    const playerNameVar=_c_1.Create_1("");
  ...
  function refreshRoomsLoop(){
    ...
    return Delay(() => Bind_1(GetAllRooms(), (a) => {
      ...
      return Combine(length_1(a)!==length_1(lastRoomState[0])||!Equals(currentState, lastRoomState[0])?(container.Set(Doc.Concat(map((r) => renderRoom(r.RoomName, r.RoomToken, r.HostName, DateFormatter(r.CreatedDT, "yyyy-MM-dd HH:mm:ss"), r.IsOpen), a))),lastRoomState[0]=currentState,Zero()):Zero(), Delay(() => Bind_1(Sleep(2000), () => refreshRoomsLoop())));
    }));
  }
...
export function RoomHostPage(roomToken, hostToken){
  const playersVar=_c_1.Create_1(FSharpList.Empty);
  const roomInfoVar=_c_1.Create_1(null);
  const lastPlayerCount=[0];
  function loop(){
    const _3=null;
    return Delay(() => Bind_1(GetPlayersInRoom(roomToken), (a) => {
      const currentCount=length_1(a);
      return Combine(currentCount!==lastPlayerCount[0]?(playersVar.Set(a),lastPlayerCount[0]=currentCount,Zero()):Zero(), Delay(() => Bind_1(Sleep(1000), () => loop())));
    }));
  }
  const _1=null;
  StartImmediate(Delay(() => Bind_1(GetPlayersInRoom(roomToken), (a) => {
    playersVar.Set(a);
    lastPlayerCount[0]=length_1(a);
    return Zero();
  })), null);
  StartImmediate(loop(), null);
  const _2=null;
  StartImmediate(Delay(() => Bind_1(GetRoomByToken(roomToken), (a) => {
    roomInfoVar.Set(a);
    return Zero();
  })), null);
  return Doc.EmbedView(Map((roomOpt) => {
    if(roomOpt==null)return Doc.Element("div", [], [Doc.TextNode("Room does not exist!")]);
      ...
      return RoomTemplatePage(room.HostName, hostToken, room.RoomName, roomToken, true, playersVar.View, ofArray([Doc.Element("button", [Attr.Create("class", "btn btn-danger btn-sm mt-2 me-2"), Handler("click", () =>() => {
        const _3=null;
        return StartImmediate(Delay(() => Bind_1(RemoveRoom(roomToken), (a) => a.$==1?(alert(a.$0),Zero()):(globalThis.close(),Zero()))), null);
      })], [Doc.TextNode("Del Room")]), Doc.Element("button", [Attr.Create("class", "btn btn-primary btn-sm mt-2 me-2"), Handler("click", () =>() => {
        const _3=null;
        return StartImmediate(Delay(() => Bind_1(SetRoomOpenState(roomToken, !room.IsOpen), (a) => a.$==1?(alert(a.$0),Zero()):Bind_1(GetRoomByToken(roomToken), (a_1) => {
          roomInfoVar.Set(a_1);
          return Zero();
        }))), null);
  ...
  return Doc.EmbedView(Map((roomOpt) => {
    if(roomOpt==null)return Doc.Element("div", [], [Doc.TextNode("Room does not exist!")]);
      ...
      return RoomTemplatePage(room.HostName, playerToken, room.RoomName, roomToken, false, playersVar.View, ofArray([Doc.Element("p", [], [Doc.TextNode("Your name: "+ownName)]), Doc.Element("button", [Attr.Create("class", "btn btn-danger btn-sm mt-2"), Handler("click", () =>() => {
        const _3=null;
        return StartImmediate(Delay(() => Bind_1(RemovePlayerFromRoom(roomToken, playerToken), (a) => a.$==1?(alert(a.$0),Zero()):(globalThis.close(),Zero()))), null);
      })], [Doc.TextNode("Exit")])]), null);
    }
  }, roomInfoVar.View));
}
function RoomTemplatePage(hostName, personalToken, roomName, roomToken, isHost, playerInfosView, leftExtras, rightExtras){
  const currentGameVar=_c_1.Create_1(null);
  const playerStateVar=_c_1.Create_1(null);
  const _1=null;
  StartImmediate(Delay(() => Bind_1(GetPlayerState(roomToken, personalToken), (a) => {
  ...
  const refreshCurrentGame=() => {
    const _3=null;
    return Delay(() => Bind_1(GetCurrentGame(roomToken), (a) => {
  ...
  function refreshGameLoop(){
    const _3=null;
    return Delay(() => Bind_1(GetCurrentGame(roomToken), (a) => Combine(!Equals(a, currentGameVar.Get())?(currentGameVar.Set(a),Zero()):Zero(), Delay(() => Bind_1(Sleep(1000), () => refreshGameLoop())))));
  }
  ...
  const playerList=Map((players) => {
    ...
    return Doc.Element("div", [Attr.Create("class", "bg-secondary text-white rounded p-3 ms-3"), Attr.Create("style", "width: 20%")], ofSeq(delay(() => append([Doc.Element("h5", [Attr.Create("class", "mb-3")], [Doc.TextNode("Players")])], delay(() => map((player) => Doc.Element("div", [Attr.Create("class", "d-flex justify-content-between align-items-center mb-2")], ofSeq(delay(() => append([Doc.Element("span", [], [Doc.TextNode(player.Name)])], delay(() => {
      ...
      return rightExtras!=null&&rightExtras.$==1&&(isHost&&player.Token!=personalToken&&(_3=rightExtras.$0,true))?[Doc.Element("button", [Attr.Create("class", "btn btn-danger btn-sm mt-2"), Attr.Create("style", "margin-left: 5px"), Handler("click", () =>() => {
        const _4=null;
        return StartImmediate(Delay(() => Bind_1(RemovePlayerFromRoom(roomToken, player.Token), (a) => a.$==1?(alert(a.$0),Zero()):Zero())), null);
  ...
  let _2=Doc.Element("div", [Attr.Create("class", "d-flex flex-wrap justify-content-between mt-3")], [Doc.Element("div", [Attr.Create("class", "bg-secondary text-white rounded p-3 me-3"), Attr.Create("style", "width: 20%")], ofSeq(delay(() => append([Doc.Element("h5", [], [Doc.TextNode(isHost?"Host datas":"Players datas")])], delay(() => append([Doc.Element("p", [], [Doc.TextNode("Room name: "+roomName)])], delay(() => append([Doc.Element("p", [], [Doc.TextNode("Host name: "+hostName)])], delay(() => leftExtras))))))))), Doc.Element("div", [Attr.Create("class", "col-md-6")], [Doc.Element("div", [Attr.Create("class", "bg-secondary text-white rounded p-3 mb-3 w-100")], [Doc.Element("h5", [], [Doc.TextNode("Game Zone")])]), Doc.EmbedView(Map((a) => {
    if(a!=null&&a.$==1){
      const gameName=a.$0;
      const _3=null;
      return Doc.Async(Delay(() => Bind_1(GetGameState(roomToken), (a_1) => {
        let _4;
      ...
      return[Doc.Element("li", [Attr.Create("class", "d-flex justify-content-between align-items-center mb-2 w-100")], ofSeq(delay(() => append([Doc.Element("div", [], [Doc.TextNode(gameName_1)])], delay(() => isHost?[Doc.Element("button", [Attr.Create("class", "btn btn-primary btn-sm"), Handler("click", () =>() => {
        const _4=null;
        return StartImmediate(Delay(() => Bind_1(SetCurrentGame(roomToken, Some(gameName_1)), () => Bind_1(refreshCurrentGame(), () => Bind_1(StartGame(roomToken), () => Return(null))))), null);
      })], [Doc.TextNode("Start")])]:[])))))];
    }, availableGames))))]);
...
function GetPlayersInRoom(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/GetPlayersInRoom", [roomToken]), (o) => Return(((DecodeList(Id()))())(o)));
}
function RemoveRoom(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/RemoveRoom", [roomToken]), (o) => Return((DecodeJson_FSharpResult_2())(o)));
}
function SetRoomOpenState(roomToken, isOpen){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/SetRoomOpenState", [roomToken, isOpen]), (o) => Return((DecodeJson_FSharpResult_2())(o)));
}
function GetRoomByToken(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/GetRoomByToken", [roomToken]), (o) => Return((DecodeJson_FSharpOption_4())(o)));
}
function RemovePlayerFromRoom(roomToken, playerToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/RemovePlayerFromRoom", [roomToken, playerToken]), (o) => Return((DecodeJson_FSharpResult_2())(o)));
}
function GetPlayerState(roomToken, playerToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/GetPlayerState", [roomToken, playerToken]), (o) => Return((DecodeJson_FSharpOption_1())(o)));
}
function GetCurrentGame(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/GetCurrentGame", [roomToken]), (o) => Return((DecodeJson_FSharpOption_3())(o)));
}
function GetGameState(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/GetGameState", [roomToken]), (o) => Return((DecodeJson_FSharpOption_2())(o)));
}
function SetCurrentGame(roomToken, gameName){
  return(new AjaxRemotingProvider()).Async("Server/SetCurrentGame", [roomToken, (EncodeJson_FSharpOption_1())(gameName)]);
}
function StartGame(roomToken){
  return Bind_1((new AjaxRemotingProvider()).Async("Server/StartGame", [roomToken]), (o) => Return((DecodeJson_FSharpResult_2())(o)));
}
...
function DecodeSet(decEl){
  return() =>(a) => new FSharpSet("New_2", OfSeq(map_2(decEl(), a)));
}
...
function showGameZone(_1, myToken, stateObj, playerStateOptObj){
        ...
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
              ...
              const s_2=value[0];
              _8=Dynamic(attrName, Map((vs) => s_2+concat_1("", vs), Sequence(value[1])));
            }
          }
          else {
            const s_3=value[0];
...
class FSharpSet extends Object_1 {
  ...
  GetHashCode(){
    return -1741749453+Hash(ofSeq_1(this));
  }
  GetEnumerator(){
